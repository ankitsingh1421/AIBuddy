...
export default function Auth() {
  ...
  return (
    <div className="w-full max-w-md px-4">
      <Card className="border-slate-200/70 bg-white/90 shadow-xl backdrop-blur">
        <CardHeader className="space-y-3 text-center">
          <CardTitle className="text-3xl font-bold tracking-tight text-slate-900">Welcome to Vectra</CardTitle>
          <CardDescription className="text-base text-slate-600">
            Sign in with Google or GitHub to continue to your dashboard.
          </CardDescription>
        </CardHeader>
